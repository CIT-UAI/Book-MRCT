...
Este capítulo describe la fuente de datos utilizada, las seis variables que componen el flujo anual, la máscara territorial de huella antrópica, los criterios de control de calidad y el procedimiento de alineamiento que garantiza coherencia entre capas.
...
Además de los mosaicos Landsat, el flujo MRCT incorpora una capa territorial de **huella antrópica** (`anthropic_aligned.tif`). Esta capa no reemplaza a los índices espectrales; opera como una máscara previa que define qué píxeles se consideran válidos para estimar los indicadores base por cuenca.
