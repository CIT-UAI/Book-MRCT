...
flowchart TB
  D["Domain (D)<br/>Distancia al estado de referencia"] --> V["Velocidad (dD/dt)<br/>Direccion y ritmo del cambio"]
...
flowchart TB
  config["Configuracion<br/>rutas, coordenadas y parametros"] --> data["Datos<br/>MRCT y cuencas"]
...
flowchart TB
  start["Parametros iniciales<br/>radios 80, 120, 150, 200 km<br/>umbrales p90, p85, p80, p75"] --> count["Contar cuencas calificadas"]
