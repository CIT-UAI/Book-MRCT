---
title: "Preevaluación de Cuencas"
subtitle: "Priorización para trabajo de terreno mediante análisis de jerk y zonas estratégicas"
---

Este capítulo presenta una preevaluación analítica de cuencas candidatas mediante el análisis de **jerk** de la Matriz de Resiliencia Climática Territorial. Su objetivo es detectar cambios abruptos en la trayectoria ecosistémica y formular preguntas de validación para el entorno operacional de Punta Arenas.
...
La lista de cuencas prioritarias es una **preselección técnica**. No equivale a una ruta final de terreno ni a una evaluación de impacto ambiental. En este libro, la cartera operativa de la campaña se presenta por separado en @sec-tabla-cuencas-seleccionadas; por ello, el ranking de jerk debe leerse como una capa de análisis y no como el listado de sitios efectivamente levantados.
:::
...
![Disponibilidad de jerk por año entre 2020 y 2025.](images/trabajo_terreno/MRCT_Cuencas_Prioritarias_Jerk_12_1.png){#fig-disponibilidad-jerk fig-align="center" width="90%"}
...
![Distribución anual de magnitud de jerk para percentiles iguales o superiores a 50%.](images/trabajo_terreno/MRCT_Cuencas_Prioritarias_Jerk_18_0.png){#fig-distribucion-anual-jerk fig-align="center" width="90%"}
...
El jerk aporta una pregunta territorial, no una ruta fija. Para cada cuenca que se considere, el análisis permite revisar el tipo de evento, su año crítico, el valor de `RES` y el contexto espacial. Esa lectura se contrasta con acceso, seguridad, clima y representatividad antes de incorporarla a una cartera de observación.

La campaña documentada en este libro utilizó su propia cartera de 17 cuencas (@tbl-cuencas-seleccionadas-detalle). Mantener ambas listas separadas hace visible la diferencia entre un ranking exploratorio y los sitios que finalmente ofrecieron condiciones para un levantamiento comparable.
...
El análisis de jerk convierte la serie MRCT en una herramienta de búsqueda: identifica rupturas temporales, mantiene una base consultable y añade contexto territorial para terminales estratégicos. Su aporte al libro es explicar dónde surgen preguntas de validación; los resultados de las visitas y su contraste con `RES` se reportan en @sec-resultados-por-cuenca-terreno.
